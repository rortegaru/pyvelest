...
/*     latter case do hypocenter/model backup): */
    ...
    adlineb_(bo, bo_len);
    checksolution_(&istopflag, &better, bo, bo_len);
...
/*     print header of this iteration : */
	...
	ici__1.icirlen = bo_len;
	ici__1.iciunit = bo;
	ici__1.icifmt = "(11x,'ITERATION no ',i2,/)";
	s_wsfi(&ici__1);
...
/*     print out the damping-factors to be used in this iteration : */
	...
	if (! coordsyst_1.single_turbo__) {
	    ...
	    ici__1.icirlen = bo_len;
	    ici__1.iciunit = bo;
	    ici__1.icifmt = "(1x,'  Othet=',f8.3,'   XYthet  =',f8.3,       "
		    "                   '   Zthet=',f7.3)";
	    s_wsfi(&ici__1);
	    ...
	    ici__1.icirlen = bo_len;
	    ici__1.iciunit = bo;
	    ici__1.icifmt = "(1x,'STAthet=',f8.3,'   Vthet   =',f8.3,/)";
	    s_wsfi(&ici__1);
...
/* matrix not positive definit !!! */
	if (! coordsyst_1.single_turbo__) {
	    ...
	    ici__1.icirlen = bo_len;
	    ici__1.iciunit = bo;
	    ici__1.icifmt = "(' WARNING: error in ludecp     ier=',i5)";
	    s_wsfi(&ici__1);
...
/* if backup was done, but less than 4 times, do forward problem again !! */
	...
	if (better) {
		...
		if (! coordsyst_1.single_turbo__) {
		    ...
		    ici__1.icirlen = bo_len;
		    ici__1.iciunit = bo;
		    ici__1.icifmt = "(' msqrd res increased',               "
			    "                          ' --> hypocenter and m"
			    "odel backup.')";
		    s_wsfi(&ici__1);
		    e_wsfi();
...
/* k            write(bo,59) (rms(i),i=1,legs) */
/*         print final rms-values of all the events */
	    adlineb_(bo, bo_len);
/* k 59         format(' Final rms values: ',10f5.2,/,(19x,10f5.2)) */
/* k            write(bo,'(//)') */
	    adlineb_(bo, bo_len);
	    i__1 = dimen_1.legs;
	    for (j = 1; j <= i__1; ++j) {
		...
		ici__1.icirlen = bo_len;
		ici__1.iciunit = bo;
		ici__1.icifmt = fmt_59;
		s_wsfi(&ici__1);
		do_fio(&c__1, (char *)&j, (ftnlen)sizeof(integer));
		do_fio(&c__1, (char *)&a4_1.rms[j - 1], (ftnlen)sizeof(real));
		e_wsfi();
		adlineb_(bo, bo_len);
	    }
	}
...
/* as input (E = po */
	...
	if (coordsyst_1.isingle != 0) {
	    ...
	    ici__1.icirlen = bo_len;
	    ici__1.iciunit = bo;
	    ici__1.icifmt = "(' Singular values:     ',4f10.4,5x,'ALE =',f7."
		    "3)";
	    s_wsfi(&ici__1);
	    for (j = 1; j <= 4; ++j) {
	    ...
	    ici__1.icirlen = bo_len;
	    ici__1.iciunit = bo;
	    ici__1.icifmt = "(1x,'data variance = ',f10.6)";
	    s_wsfi(&ici__1);
	...
	resolcovar_(&a3_1.davar1, bo, bo_len);
    }
/*      if (s(2).gt.99.9) then */
/*         errx = 999 */
/*      else */
...
/*     output cpu-statistics for whole VELEST-run: */
	...
	ici__1.icirlen = bo_len;
	ici__1.iciunit = bo;
	ici__1.icifmt = "(1x,'TOTAL CPU-sec      ',3x,' =',f7.1,5x,         "
		"            '(CPU-minutes:',f7.3,')')";
	s_wsfi(&ici__1);
...
/* L998: */
    openerror_("main program", "data-input-file FOR008", bo, (ftnlen)12, (
	    ftnlen)22, bo_len);
...
/* Subroutine */ int inputparam_(char *bo, ftnlen bo_len)
{
    ...
    extern /* Subroutine */ int rdline_ic__(char *, ftnlen), rdline_bm__(char 
	    *, ftnlen), rdline_bt__(char *, ftnlen);
    ...
    /* Fortran I/O blocks */
    static icilist io___50 = { 0, line, 0, "(a)", 80, 1 };
    static icilist io___52 = { 0, line+80, 0, 0, 80, 1 };
    static icilist io___55 = { 0, line+160, 0, 0, 80, 1 };
    static icilist io___57 = { 0, line+240, 0, 0, 80, 1 };
    static icilist io___58 = { 0, line+320, 0, 0, 80, 1 };
    static icilist io___59 = { 0, line+400, 0, 0, 80, 1 };
    static icilist io___60 = { 0, line+480, 0, 0, 80, 1 };
    static icilist io___61 = { 0, line+560, 0, 0, 80, 1 };
    static icilist io___62 = { 0, line+640, 0, 0, 80, 1 };
    static icilist io___63 = { 0, line+720, 0, 0, 80, 1 };
    static icilist io___64 = { 0, line+800, 0, 0, 80, 1 };
    static icilist io___65 = { 0, line+880, 0, "(a)", 80, 1 };
    static icilist io___66 = { 0, line+960, 0, "(a)", 80, 1 };
    static icilist io___67 = { 0, line+1040, 0, "(a)", 80, 1 };
    static icilist io___68 = { 0, line+1120, 0, "(a)", 80, 1 };
    static icilist io___69 = { 0, line+1200, 0, "(a)", 80, 1 };
    static icilist io___70 = { 0, line+1280, 0, "(a)", 80, 1 };
    static icilist io___71 = { 0, line+1360, 0, "(a)", 80, 1 };
    static icilist io___72 = { 0, line+1440, 0, "(a)", 80, 1 };
    static icilist io___73 = { 0, line+1520, 0, "(a)", 80, 1 };
    static icilist io___74 = { 0, line+1600, 0, "(a)", 80, 1 };
    static icilist io___75 = { 0, line+1680, 0, "(a)", 80, 1 };
    static icilist io___76 = { 0, line+1760, 0, "(a)", 80, 1 };
    static icilist io___77 = { 0, line+1840, 0, "(a)", 80, 1 };
    static icilist io___78 = { 0, line+1920, 0, "(a)", 80, 1 };
    static icilist io___79 = { 0, line+2000, 0, "(a)", 80, 1 };
    static icilist io___80 = { 0, line+2080, 0, "(a)", 80, 1 };
    static icilist io___81 = { 0, line+2160, 0, "(a)", 80, 1 };
    static icilist io___82 = { 0, line+2240, 0, "(a)", 80, 1 };
    static icilist io___83 = { 0, line+2320, 0, "(a)", 80, 1 };
...
/* VMS         open(16,file=outfile,status='new',carriagecontrol='list') */
	...
	o__1.oblnk = 0;
	f_open(&o__1);
/*        write(6,*) 'Antes del primer llamado ' */
	ici__1.icierr = 0;
	ici__1.icirnum = 1;
	ici__1.icirlen = bo_len;
	ici__1.iciunit = bo;
	...
	e_wsfi();
	adlineb_(bo, bo_len);
/*        write(6,*) 'Despues del primer llamado' */
	ici__1.icierr = 0;
	ici__1.icirnum = 1;
	ici__1.icirlen = bo_len;
	ici__1.iciunit = bo;
...
/*     print the input-parameters */
	...
	ici__1.icirlen = bo_len;
	ici__1.iciunit = bo;
	ici__1.icifmt = "(1x,f10.6,f11.6,6x,i1,10x,f7.3,7x,i1,3x,f6.2,6x,i1)";
	s_wsfi(&ici__1);
	...
	ici__1.icirlen = bo_len;
	ici__1.iciunit = bo;
	ici__1.icifmt = "(1x,i6,1x,i6,3x,f6.1)";
	s_wsfi(&ici__1);
	...
	ici__1.icirlen = bo_len;
	ici__1.iciunit = bo;
	ici__1.icifmt = "(2x,f7.2,5x,i1,4x,f6.2,6x,f5.2,3x,f5.2,7x,i1)";
	s_wsfi(&ici__1);
	...
	ici__1.icirlen = bo_len;
	ici__1.iciunit = bo;
	ici__1.icifmt = "(5x,i1,5x,f5.2,3x,f6.3,7x,i2)";
	s_wsfi(&ici__1);
	...
	ici__1.icirlen = bo_len;
	ici__1.iciunit = bo;
	ici__1.icifmt = "(7x,3(i1,7x),4x,i1,12x,i1)";
	s_wsfi(&ici__1);
	...
	ici__1.icirlen = bo_len;
	ici__1.iciunit = bo;
	ici__1.icifmt = "(7x,i1,9x,i1,9x,i1,9x,i1)";
	s_wsfi(&ici__1);
	...
	ici__1.icirlen = bo_len;
	ici__1.iciunit = bo;
	ici__1.icifmt = "(3x,f6.3,6x,i2,9x,i2)";
	s_wsfi(&ici__1);
...
/*     For more details see comments on top of this program-source! */
	...
	if (olon <= 0.f) {
	    ...
	    ici__1.icirlen = bo_len;
	    ici__1.iciunit = bo;
	    ici__1.icifmt = "(6x,f10.5,2hN ,f11.5,1hE)";
	    s_wsfi(&ici__1);
	    do_fio(&c__1, (char *)&olat, (ftnlen)sizeof(real));
	    r__1 = -olon;
	    do_fio(&c__1, (char *)&r__1, (ftnlen)sizeof(real));
	    ...
	    ici__1.icirlen = bo_len;
	    ici__1.iciunit = bo;
	    ici__1.icifmt = "(6x,f10.5,2hN ,f11.5,1hW)";
	    s_wsfi(&ici__1);
	    do_fio(&c__1, (char *)&olat, (ftnlen)sizeof(real));
	    do_fio(&c__1, (char *)&olon, (ftnlen)sizeof(real));
	    e_wsfi();
	...
	ici__1.icirlen = bo_len;
	ici__1.iciunit = bo;
	ici__1.icifmt = "(12x,7hrotate=,1x,f6.1,1x,5hdegr.)";
	s_wsfi(&ici__1);
	do_fio(&c__1, (char *)&rotate, (ftnlen)sizeof(real));
	e_wsfi();
	ici__1.icierr = 0;
	...
	if (coordsyst_1.icoordsystem == 2) {
	    ...
	    e_wsli();
	    adlineb_(bo, bo_len);
/* cc            write(bo,*)'---> no rotation can be performed !!!' */
	} else {
	    ici__1.icierr = 0;
	    ici__1.icirnum = 1;
	    ici__1.icirlen = bo_len;
...
/*     write(6,*)'Nplay (i) =',nplay(i) */
	...
	for (j = 1; j <= i__2; ++j) {
		...
		if (! coordsyst_1.single_turbo__) {
		    ...
		    ici__1.icirlen = bo_len;
		    ici__1.iciunit = bo;
		    ici__1.icifmt = "(2x,i2,3x,2f7.2,1x,f7.2,1x,a1,1x,a40)";
		    s_wsfi(&ici__1);
		    do_fio(&c__1, (char *)&j, (ftnlen)sizeof(integer));
		    do_fio(&c__1, (char *)&layvel_1.vp[i__ + (j << 1) - 3], (
			    ftnlen)sizeof(real));
...
/*    calculate and print average velocities of the model i : */
	...
	if (! coordsyst_1.single_turbo__) {
		...
		ici__1.icirlen = bo_len;
		ici__1.iciunit = bo;
		ici__1.icifmt = "(' z =',f6.2,' ...',f6.2,'    v = ',f4.2,  "
			"                 '    AVEL = ',f4.2,' downto z = ',f"
			"6.2)";
		s_wsfi(&ici__1);
...
/* L14: */
	...
	if (! coordsyst_1.single_turbo__) {
	    ...
	    ici__1.icirlen = bo_len;
	    ici__1.iciunit = bo;
	    ici__1.icifmt = "(1x,'Phases in the input-phaselist marked with "
		    "a  ',            a1,/,' are treated as reflections from "
		    "the bottom ',            'of layer nr. ',i2)";
	    s_wsfi(&ici__1);
...
/* note this is not the best way to check the EOF ROR. 31-03-2020.1 */
...
/* L9911: */
    ...
    return 0;
/* L9912: */
    openerror_("inputparam", "station-input-file (FOR010)", bo, (ftnlen)10, (
	    ftnlen)27, bo_len);
    return 0;
L9913:
    openerror_("inputparam", "seismo-input-file (FOR010)", bo, (ftnlen)10, (
	    ftnlen)26, bo_len);
    return 0;
...
/* of subr. inputparam */
/* Subroutine */ int inputdata_(integer *i__, char *bo, ftnlen bo_len)
{
    /* Initialized data */
    ...
    integer s_wsfe(cilist *), do_fio(integer *, char *, ftnlen), e_wsfe(void),
	    ...
	    e_wsle(void), s_cmp(char *, char *, ftnlen, ftnlen), s_wsli(
	    icilist *), e_wsli(void), s_wsfi(icilist *), e_wsfi(void);
    ...
    /* Fortran I/O blocks */
    static cilist io___137 = { 0, 6, 0, "(1x,'Event #',i4)", 0 };
    static cilist io___138 = { 0, 6, 0, 0, 0 };
    static cilist io___139 = { 0, 2, 0, "('1 E V E N T   N R .   ',i6,      "
	    "                              '                 ',              "
	    "                              '           0                    0"
	    "')", 0 };
    static cilist io___140 = { 0, 6, 0, "(1x,'Event #',i6)", 0 };
    ...
    static cilist io___152 = { 0, 2, 0, "(' DELETED: ',a4,                  "
    ...
    static cilist io___158 = { 0, 6, 0, "(' WARNING:  Station: >>>',a4,     "
	    "                               '<<< not found in stationlist!')", 
	    0 };
    static cilist io___159 = { 0, 6, 0, 0, 0 };
    static cilist io___160 = { 0, 6, 0, 0, 0 };
    static cilist io___161 = { 0, 2, 0, "(' DELETED: ',a4,                  "
	    "                              ' not on station-list')", 0 };
    static cilist io___163 = { 0, 6, 0, "(' epicentral distance:',f6.1,     "
	    "                               ' > dmax (',f6.1,') ==> skipping "
	    "phase !')", 0 };
    ...
    static cilist io___169 = { 0, 6, 0, "(1x,'---> ',3i2.2,1x,2i2.2)", 0 };
...
/* c          write(bo,'('' first station is '',a4)') sta(jjmin) */
	    adlineb_(bo, bo_len);
	    jjmin1 = 0;
	    i__1 = dimen_1.nsta;
	    for (jj = 1; jj <= i__1; ++jj) {
...
/* L16: */
	...
	if (! coordsyst_1.single_turbo__) {
	    ...
	    ici__1.icirlen = bo_len;
	    ici__1.iciunit = bo;
	    ici__1.icifmt = "(' WARNING:  Station: >>>',a4,                 "
		    "                  '<<< not found in stationlist!')";
	    s_wsfi(&ici__1);
	    do_fio(&c__1, sta + (j - 1 << 2), (ftnlen)4);
	    e_wsfi();
...
/* Computing 2nd power */
	...
	if (ss1 > param_1.dmax__) {
		...
		ici__1.icirlen = bo_len;
		ici__1.iciunit = bo;
		ici__1.icifmt = "(' epicentral distance:',f6.1,             "
			"                      ' > dmax (',f6.1,') ==> skippi"
			"ng phase !')";
		s_wsfi(&ici__1);
...
/* twice the same phase in thi */
			...
			if (! coordsyst_1.single_turbo__) {
			    ...
			    ici__1.icirlen = bo_len;
			    ici__1.iciunit = bo;
			    ici__1.icifmt = "(1x,'---> ',3i2.2,1x,2i2.2)";
			    s_wsfi(&ici__1);
...
/* ek print P and S number of obs */
		...
		ici__1.icirlen = bo_len;
		ici__1.iciunit = bo;
		ici__1.icifmt = "(1x,i3,1x,3i2.2,1x,2i2.2,1x,f5.2,1x,f7.4,a1"
			",                     1x,f8.4,a1,1x,f6.2,3f7.2,f5.2,"
			"i2,i4,3x,2i5)";
		s_wsfi(&ici__1);
		do_fio(&c__1, (char *)&(*i__), (ftnlen)sizeof(integer));
...
L998:
    openerror_("inputdata", "EQ-data-input-file FOR008", bo, (ftnlen)9, (
	    ftnlen)25, bo_len);
L999:
    openerror_("inputdata", "SHOT-data-input-file FOR009", bo, (ftnlen)9, (
	    ftnlen)27, bo_len);
    return 0;
...
/* of subr. inputdata */
/* Subroutine */ int statisticsout_(char *bo, ftnlen bo_len)
{
    /* System generated locals */
    integer i__1, i__2;
    real r__1;
    ...
    /* Builtin functions */
    integer s_wsli(icilist *), e_wsli(void), do_lio(integer *, integer *, 
	    char *, ftnlen), s_wsfi(icilist *), do_fio(integer *, char *, 
	    ftnlen), e_wsfi(void), i_nint(real *);
    /* Subroutine */ int s_copy(char *, char *, ftnlen, ftnlen);
...
/* hitlay(i,1) = nofHITS of */
	...
	ici__1.icirlen = bo_len;
	ici__1.iciunit = bo;
	ici__1.icifmt = "(2x,i2,3x,f6.2,'...',f6.2,' km   ',                "
    ...
    ici__1.icirlen = bo_len;
    ici__1.iciunit = bo;
    ici__1.icifmt = "(2x,i2,3x,f6.2,'...',5x,'  km   ',                     "
    ...
    ici__1.icirlen = bo_len;
    ici__1.iciunit = bo;
    ici__1.icifmt = "(' Total nr of events was ',i4)";
    s_wsfi(&ici__1);
    ...
    ici__1.icirlen = bo_len;
    ici__1.iciunit = bo;
    ici__1.icifmt = "(' Total nr of refracted rays = ',i5)";
    s_wsfi(&ici__1);
    ...
    ici__1.icirlen = bo_len;
    ici__1.iciunit = bo;
    ici__1.icifmt = "(' Total nr of reflected rays = ',i5)";
    s_wsfi(&ici__1);
    ...
    ici__1.icirlen = bo_len;
    ici__1.iciunit = bo;
    ici__1.icifmt = "(' Total nr of   other   rays = ',i5)";
    s_wsfi(&ici__1);
    ...
    ici__1.icirlen = bo_len;
    ici__1.iciunit = bo;
    ici__1.icifmt = "(' Total nr of    all    rays = ',i5)";
    s_wsfi(&ici__1);
    ...
    ici__1.icirlen = bo_len;
    ici__1.iciunit = bo;
    ici__1.icifmt = "(1x,' Straight and direct rays : ',f7.2,' meters')";
    s_wsfi(&ici__1);
    ...
    ici__1.icirlen = bo_len;
    ici__1.iciunit = bo;
    ici__1.icifmt = "(1x,' Refracted           rays : ',f7.2,' meters')";
    s_wsfi(&ici__1);
    do_fio(&c__1, (char *)&err, (ftnlen)sizeof(real));
    e_wsfi();
    adlineb_(bo, bo_len);
    ...
    ici__1.icirlen = bo_len;
    ici__1.iciunit = bo;
    ici__1.icifmt = "(1x,' Reflected           rays : ',f7.2,' meters')";
    s_wsfi(&ici__1);
    do_fio(&c__1, (char *)&err, (ftnlen)sizeof(real));
    e_wsfi();
    adlineb_(bo, bo_len);
    ...
    ici__1.icirlen = bo_len;
    ici__1.iciunit = bo;
    ici__1.icifmt = "(1x,'Average horizontal ray length = ',                "
    ...
    ici__1.icirlen = bo_len;
    ici__1.iciunit = bo;
    ici__1.icifmt = "(1x,'Average  vertical  ray length = ',                "
    ...
    ici__1.icirlen = bo_len;
    ici__1.iciunit = bo;
    ici__1.icifmt = "(1x,'GAPs were between ',i3,' and ',i3)";
    s_wsfi(&ici__1);
    i__1 = i_nint(&mini);
    do_fio(&c__1, (char *)&i__1, (ftnlen)sizeof(integer));
    i__2 = i_nint(&maxi);
    ...
    ici__1.icirlen = bo_len;
    ici__1.iciunit = bo;
    ici__1.icifmt = "('      (average GAP was ',i3,')')";
    s_wsfi(&ici__1);
	...
	if (nobsnr[i__ - 1] > 0) {
	    ...
	    ici__1.icirlen = bo_len;
	    ici__1.iciunit = bo;
	    ici__1.icifmt = "(1x,'MAG = ',f3.1,' (',i3,') ',a)";
	    s_wsfi(&ici__1);
	...
	if (depthnri[i__ - 1] > 0) {
	    ...
	    ici__1.icirlen = bo_len;
	    ici__1.iciunit = bo;
	    ici__1.icifmt = "(1x,'DEPTH ( input ) = ',f4.0,' km :  ',a)";
	    s_wsfi(&ici__1);
	...
	if (depthnrl[i__ - 1] > 0) {
	    ...
	    ici__1.icirlen = bo_len;
	    ici__1.iciunit = bo;
	    ici__1.icifmt = "(1x,'DEPTH (last_IT) = ',f4.0,' km :  ',a)";
	    s_wsfi(&ici__1);
...
/* c         write(bo,*) */
	...
	ici__1.icirlen = bo_len;
	ici__1.iciunit = bo;
	ici__1.icifmt = "(1x,'DEPTH ( input ) > 100. ','km :  ',a)";
	s_wsfi(&ici__1);
	...
	ici__1.icirlen = bo_len;
	ici__1.iciunit = bo;
	ici__1.icifmt = "(1x,'DEPTH (last_IT) > 100. ','km :  ',a)";
	s_wsfi(&ici__1);
    ...
    ici__1.icirlen = bo_len;
    ici__1.iciunit = bo;
    ici__1.icifmt = "(1x,'Stn#  Stn     RES          RES1        ',         "
	    "          ' RES2         RES3         RES4')";
    s_wsfi(&ici__1);
    e_wsfi();
    i__1 = dimen_1.nsta;
	...
	if (tot > 0.f) {
	    ...
	    ici__1.icirlen = bo_len;
	    ici__1.iciunit = bo;
	    ici__1.icifmt = "(1x,i3,3x,a4,1x,5(f7.2,'(',i4,')'))";
	    s_wsfi(&ici__1);
	    do_fio(&c__1, (char *)&i__, (ftnlen)sizeof(integer));
...
/* Subroutine */ int statislout_(char *bo, ftnlen bo_len)
{
    /* Initialized data */
    ...
    /* Builtin functions */
    integer s_wsli(icilist *), do_lio(integer *, integer *, char *, ftnlen), 
	    e_wsli(void), s_wsle(cilist *), e_wsle(void), s_wsfe(cilist *), 
	    e_wsfe(void);
    double sqrt(doublereal);
    ...
    static cilist io___226 = { 0, 2, 0, "(' ERROR: insufficient data to loca"
	    "te the quake!')", 0 };
    static cilist io___227 = { 0, 2, 0, "('0 DATE  ORIGIN   TIME   LAT      "
	    "LON     DEPTH ',              ' MAG  NO  DM GAP  RMS   ALE D-SPR"
	    "')", 0 };
    static cilist io___228 = { 0, 2, 0, "('0 DATE  ORIGIN TIME   LAT       L"
	    "ON     *DEPTH*',              ' MAG  NO  DM GAP  RMS   ALE D-SPR"
	    "')", 0 };
    static cilist io___229 = { 0, 2, 0, "('0 DATE  ORIGIN TIME  *LAT*     *L"
	    "ON*    *DEPTH*',              ' MAG  NO  DM GAP  RMS   ALE D-SPR"
	    "')", 0 };
    static cilist io___239 = { 0, 2, 0, "(1x,3i2.2,1x,i2,':',i2,':',f6.3,1x "
	    "                            f7.4,a1,f8.4,a1,1x,f7.3,2x,         "
	    "                              f3.1,2x,i2,1x,i3,1x,i3,f5.2,f6.2, "
	    "                                1x,f5.2)", 0 };
    static cilist io___240 = { 0, 2, 0, "('0  ERX  ERY  ERZ Q SQD  ADJ  IN N"
	    "R  ',                         'AVR   AAR  NM AVXM  SDXM IT')", 0 }
	    ;
    static cilist io___257 = { 0, 2, 0, "(1x,f5.1,f5.1,f5.1,1x,a1,1x,a1,'/',"
	    "a1,f6.2,1x,                   i2,i3,2f6.2,                      "
	    "                                i3,2x,f3.1,2x,f3.1,1x,i3)", 0 };
    static cilist io___258 = { 0, 2, 0, "('0 L+T NR:',i4,1x,a32,'CH-COORD.:'"
	    ",                  f9.3,' /',f9.3, ' KM')", 0 };
    static cilist io___259 = { 0, 2, 0, "('0 F-E NR:',i4,1x,a32,'CH-COORD.:'"
	    ",                  f9.3,' /',f9.3, ' KM')", 0 };
    static cilist io___260 = { 0, 2, 0, "('0 F-E NR:',i4,1x,a32)", 0 };
    static cilist io___261 = { 0, 2, 0, "('0 STN  DIST AZM AIN PRMK HRMN  P-"
	    "SEC  TPOBS  TPCAL ',          ' -TSCOR  P-RES   P-WT IMP STURES')"
	    , 0 };
    static cilist io___262 = { 0, 2, 0, "('        AMX PRX     SRMK XMAG  S-"
	    "SEC  TSOBS  TSCAL ',          ' -TSCOR  S-RES   S-WT IMP STURES')"
	    , 0 };
    static icilist io___277 = { 0, card, 0, "(2X,A4,1x,2i4,I4,1X,3A1,I1,a1,2"
	    "I2,3F7.3,F7.3,1x,                   f7.3,1x,f6.2,1x,f6.4,f7.3)", 
	    90, 1 };
    static icilist io___278 = { 0, card+15, 0, "(i4)", 4, 1 };
    static cilist io___279 = { 0, 2, 0, "(a)", 0 };
    static cilist io___280 = { 0, 2, 0, "(a)", 0 };
    static icilist io___282 = { 0, card, 0, "(2x,4x,i5,f4.1)", 15, 1 };
    static icilist io___283 = { 0, card+25, 0, "(f3.1)", 3, 1 };
    static icilist io___284 = { 0, card+2, 0, "(a4)", 4, 1 };
    static icilist io___285 = { 0, card+20, 0, "(3a1,i1,a1)", 5, 1 };
    static icilist io___286 = { 0, card+29, 0, "(3F7.3,F7.3,1x,f7.3,1x,F6.2,"
	    "1x,f6.4,                               f7.3)", 61, 1 };
    static cilist io___287 = { 0, 2, 0, "(a)", 0 };
...
/* of subr. statislout */
/* Subroutine */ int nittoutput_(real *damp, char *bo, ftnlen bo_len)
{
    /* Format strings */
    ...
    /* Builtin functions */
    integer s_wsli(icilist *), e_wsli(void), s_wsfi(icilist *), e_wsfi(void), 
...
/*     output hypocenters of this iteration: */
    ...
    ici__1.icirlen = bo_len;
    ici__1.iciunit = bo;
    ici__1.icifmt = "(4h  eq, 7x, 2hot, 5x, 1hx, 6x, 1hy, 6x, 1hz, 6x,3hrms,"
...
/*     print constrain-info if necessary: */
	...
	if (event_1.iconstrain[i__ - 1] == 1) {
	    ...
	    ici__1.icirlen = bo_len;
	    ici__1.iciunit = bo;
	    ici__1.icifmt = "(' ***** depth constrained for event ',i5)";
	    s_wsfi(&ici__1);
	    do_fio(&c__1, (char *)&i__, (ftnlen)sizeof(integer));
	    e_wsfi();
	    adlineb_(bo, bo_len);
...
/* loop over all events (printout) */
    ...
    ici__1.icirlen = bo_len;
    ici__1.iciunit = bo;
    ici__1.icifmt = "(' A V E R A G E   of ADJUSTMENTS :',19x,4f7.3)";
    s_wsfi(&ici__1);
    ...
    ici__1.icirlen = bo_len;
    ici__1.iciunit = bo;
    ici__1.icifmt = "(' A V E R A G E   of ABSOLUTE ADJUSTMENTS :',10x,     "
	    "          4f7.3)";
    s_wsfi(&ici__1);
...
/*     all new hypocenters printed out now. */
	...
	ici__1.icirlen = bo_len;
	ici__1.iciunit = bo;
	ici__1.icifmt = "(/,'NO step length damping applied',/)";
	s_wsfi(&ici__1);
	e_wsfi();
	adlineb_(bo, bo_len);
    }
...
/* no station-correction adjustments... */
    ...
    ici__1.icirlen = bo_len;
    ici__1.iciunit = bo;
    ici__1.icifmt = "(' Adjusted station corrections:')";
    s_wsfi(&ici__1);
    e_wsfi();
    ici__1.icierr = 0;
    ici__1.icirnum = 1;
...
/* of subr. nittoutput */
/* Subroutine */ int finalhypocout_(char *bo, ftnlen bo_len)
{
    /* Format strings */
    ...
    extern /* Subroutine */ int gapcalc_(integer *, char *, ftnlen), adlineb_(
	    char *, ftnlen);

    /* Fortran I/O blocks */
    static cilist io___314 = { 0, 6, 0, fmt_1111, 0 };
    static cilist io___324 = { 0, 6, 0, "(1x,3i2.2,1x,2i2.2,f6.2,           "
	    "                                 1x,f7.4,a1,1x,f8.4,a1,1x,      "
	    "                                   f6.2,f5.2,i4,f6.3,2f7.2,f6.2)",
	     0 };
    static icilist io___340 = { 0, a4_1.smpline, 0, "(i4,4i2.2,i3.3,i5.5,a1,"
	    "i6.6,a1,                               i3.3,i2.2,'Ml',i4.4,2i3,'"
	    "000000000SEDL',                      2i3,i4.4,i2)", 80, 1 };
    static cilist io___341 = { 0, 11, 0, "(a80)", 0 };
    static cilist io___342 = { 0, 6, 0, "(1x,a32,'   L+T Nr.: ',i4)", 0 };
    static cilist io___343 = { 0, 6, 0, "(1x,a32,'   F-E Nr.: ',i4)", 0 };
    static cilist io___344 = { 0, 7, 0, "(3i2,1x,2i2,1x,f5.2,1x,f7.4,a1,1x,f"
	    "8.4,a1,2f7.2,                  4x,i3,5x,f5.2)", 0 };
    static cilist io___347 = { 0, 7, 0, fmt_19, 0 };
    static cilist io___348 = { 0, 7, 0, 0, 0 };
...
/*  U.K. 3.Feb.87 */
	...
	if (! coordsyst_1.single_turbo__) {
	    ...
	    ici__1.icirlen = bo_len;
	    ici__1.iciunit = bo;
	    ici__1.icifmt = "(1x,i3,1x,3i2.2,1x,2i2.2,f6.2,                 "
		    "                    1x,f7.4,a1,1x,f8.4,a1,1x            "
...
/* cc      if(.not.single_turbo) write(bo,*) */
	adlineb_(bo, bo_len);
	if (coordsyst_1.isingle != 0) {
	    if (! coordsyst_1.single_turbo__) {
		ici__1.icierr = 0;
		...
		ici__1.icirlen = bo_len;
		ici__1.iciunit = bo;
		ici__1.icifmt = "(1x,'Event# ',i3,' GAP = ',i3)";
		s_wsfi(&ici__1);
		...
		if (! coordsyst_1.single_turbo__) {
		    ...
		    ici__1.icirlen = bo_len;
		    ici__1.iciunit = bo;
		    ici__1.icifmt = "(1x,a32,'   L+T Nr.: ',i4)";
		    s_wsfi(&ici__1);
		    do_fio(&c__1, event_1.regionname, (ftnlen)32);
		...
		if (! coordsyst_1.single_turbo__) {
		    ...
		    ici__1.icirlen = bo_len;
		    ici__1.iciunit = bo;
		    ici__1.icifmt = "(1x,a32,'   F-E Nr.: ',i4)";
		    s_wsfi(&ici__1);
		    do_fio(&c__1, event_1.regionname, (ftnlen)32);
		    do_fio(&c__1, (char *)&event_1.nreg, (ftnlen)sizeof(
			    integer));
...
/* Subroutine */ int openerror_(char *subr, char *char__, char *bo, ftnlen 
	subr_len, ftnlen char_len, ftnlen bo_len)
{
    /* System generated locals */
    icilist ici__1;
    ...
    integer s_wsle(cilist *), do_lio(integer *, integer *, char *, ftnlen), 
	    e_wsle(void), s_wsli(icilist *), e_wsli(void);
    /* Subroutine */ int s_stop(char *, ftnlen);
	...
	integer *ier, ftnlen stn_len, ftnlen sfreq_len)
{
    ...
    /* Fortran I/O blocks */
    static cilist io___353 = { 0, 10, 1, "(a)", 0 };
	...
	cphase_len, ftnlen eventtype_len)
{
    ...
    /* Fortran I/O blocks */
    static cilist io___373 = { 0, 0, 1, "(a)", 0 };
    static icilist io___375 = { 1, cline, 1, "(3i2,1x,2i2,1x,f5.2,1x,f7.4,a1"
	    ",1x,f8.4,a1,1x,f7.2,          2x,f5.2)", 80, 1 };
    static cilist io___380 = { 0, 0, 1, "(6(a4,a1,i1,f6.2))", 0 };
    static cilist io___383 = { 0, 6, 0, 0, 0 };
    static cilist io___384 = { 0, 6, 0, "(a)", 0 };
...
L2:
    io___373.ciunit = *iunit;
    i__1 = s_rsfe(&io___373);
    if (i__1 != 0) {
	goto L99;
    }
...
L10:
    j1 = j2 + 1;
    j2 = j1 + 5;
    io___380.ciunit = *iunit;
    i__1 = s_rsfe(&io___380);
    if (i__1 != 0) {
	goto L999;
    }
    i__2 = j2;
	...
	cphase_len, ftnlen eventtype_len)
{
    ...
    /* Fortran I/O blocks */
    static cilist io___385 = { 0, 0, 1, "(a)", 0 };
    static icilist io___387 = { 1, cline, 1, "(3i2,1x,2i2,1x,f5.2,1x,f7.4,a1"
	    ",1x,f8.4,a1,1x,f7.2,          2x,f5.2)", 80, 1 };
    static cilist io___393 = { 0, 0, 1, "(2x,a4,2x,a1,3x,i1,3x,f6.2)", 0 };
    static cilist io___395 = { 0, 6, 0, 0, 0 };
    static cilist io___396 = { 0, 6, 0, "(a)", 0 };
...
L2:
    io___385.ciunit = *iunit;
    i__1 = s_rsfe(&io___385);
    if (i__1 != 0) {
	goto L999;
    }
    i__1 = do_fio(&c__1, cline, (ftnlen)80);
...
/*     SHOTS: i1=icc */
	...
	*xlon = -(*xlon);
    ...
    j1 = 1;
    for (j = 1; j <= 180; ++j) {
	io___393.ciunit = *iunit;
	i__1 = s_rsfe(&io___393);
	if (i__1 != 0) {
	    goto L99;
	}
	i__1 = do_fio(&c__1, sta + (j << 2), (ftnlen)4);
	...
	rmk2_len, ftnlen cphase_len, ftnlen eventtype_len)
{
    ...
    /* Fortran I/O blocks */
    static cilist io___398 = { 0, 0, 1, "(a)", 0 };
    static icilist io___400 = { 0, cline, 0, "(17x,i1,i1,f5.2,2f8.3)", 80, 1 }
	    ;
    static icilist io___401 = { 1, cline, 0, "(a4,a1,a1,a1,i1,a1,5i2,f5.2,7x"
	    ",                                   f5.2,2x,a1,i1,4x,f3.0,f3.1)", 
	    80, 1 };
    static icilist io___409 = { 0, cline+63, 0, "(a1)", 1, 1 };
    static icilist io___410 = { 0, cline+75, 0, "(i4)", 4, 1 };
    static cilist io___416 = { 0, 6, 0, 0, 0 };
    static cilist io___417 = { 0, 6, 0, "(a)", 0 };
...
L1:
    io___398.ciunit = *iunit;
    i__1 = s_rsfe(&io___398);
    if (i__1 != 0) {
	goto L999;
    }
    i__1 = do_fio(&c__1, cline, (ftnlen)80);
	...
	rmk1_len, ftnlen rmk2_len, ftnlen cphase_len, ftnlen eventtype_len)
{
    ...
    /* Fortran I/O blocks */
    static cilist io___419 = { 0, 0, 1, "(a)", 0 };
    static icilist io___421 = { 0, cline, 0, "(29x,i2)", 80, 1 };
    static icilist io___422 = { 0, cline, 0, 0, 80, 1 };
    static cilist io___424 = { 0, 0, 1, "(a)", 0 };
    static icilist io___425 = { 0, cline, 0, "(2x,i2,1x,i2,1x,i2,1x,i2,1x,i2)"
	    , 80, 1 };
    static icilist io___431 = { 0, cline+54, 0, "(a1)", 1, 1 };
    static icilist io___432 = { 0, cline+70, 0, "(i8)", 8, 1 };
    static icilist io___433 = { 1, cline, 0, "(a4,4x,a8,a1,a1,f8.3,i2,f5.2,f"
	    "9.0,1x,a8,i3)", 80, 1 };
    static cilist io___449 = { 0, 6, 0, 0, 0 };
    static cilist io___450 = { 0, 6, 0, "(a)", 0 };
...
L1:
    io___419.ciunit = *iunit;
    i__1 = s_rsfe(&io___419);
    if (i__1 != 0) {
	goto L999;
    }
    i__1 = do_fio(&c__1, cline, (ftnlen)80);
...
/*        Reading the line after the TRIAL card */
	...
	io___424.ciunit = *iunit;
	i__1 = s_rsfe(&io___424);
	if (i__1 != 0) {
	    goto L999;
	}
	i__1 = do_fio(&c__1, cline, (ftnlen)80);
...
/* Subroutine */ int checksolution_(integer *istopflag, logical *better, char 
	*bo, ftnlen bo_len)
{
    /* Format strings */
    ...
    /* Builtin functions */
    integer s_wsli(icilist *), e_wsli(void), s_wsfi(icilist *), do_fio(
    ...
    extern /* Subroutine */ int avresistatist_(char *, ftnlen);
    static real datvar;
    extern /* Subroutine */ int gapcalc_(integer *, char *, ftnlen), adlineb_(
	    char *, ftnlen);
    static real xmsqrs2;
...
/* **************   end of VELESTCOMMON.FOR  ******************************* */
    ...
    *better = TRUE_;
	...
	if (a3_1.ibackups == 0) {
	    ...
	    ici__1.icirlen = bo_len;
	    ici__1.iciunit = bo;
	    ici__1.icifmt = "(' Iteration nr ',i2,' obtained:')";
	    s_wsfi(&ici__1);
	    do_fio(&c__1, (char *)&form_1.nitt, (ftnlen)sizeof(integer));
	    e_wsfi();
	    adlineb_(bo, bo_len);
	    ...
	    ici__1.icirlen = bo_len;
	    ici__1.iciunit = bo;
	    ici__1.icifmt = "('(Iteration nr ',i2,')   BACKUP nr ',i1,      "
		    "                ' obtained:')";
	    s_wsfi(&ici__1);
	    do_fio(&c__1, (char *)&form_1.nitt, (ftnlen)sizeof(integer));
    ...
    if (coordsyst_1.isingle != 0) {
	gapcalc_(&c__1, bo, bo_len);
    }

    if (coordsyst_1.isingle == 0) {
	avresistatist_(bo, bo_len);
    }
...
/*       msqrd residual decreasing, but data variance increased: */
	...
	if (! coordsyst_1.single_turbo__) {
	    ...
	    ici__1.icirlen = bo_len;
	    ici__1.iciunit = bo;
	    ici__1.icifmt = "(' *** WARNING: the data variance has increased"
		    ".')";
	    s_wsfi(&ici__1);
	    e_wsfi();
	    adlineb_(bo, bo_len);
...
/* Subroutine */ int traveltime_(integer *i__, integer *nobs, integer *
	iresflag, char *bo, ftnlen bo_len)
{
    /* Format strings */
    ...
    extern /* Subroutine */ int travderiv_(char *, integer *, integer *, real 
	    *, real *, real *, integer *, real *, real *, real *, real *, 
	    real *, real *, integer *, integer *, char *, ftnlen, ftnlen);
    ...
    extern /* Subroutine */ int raypath_(integer *, integer *, integer *, 
	    ...
	    integer *, real *, real *, real *, real *, real *, real *, char *,
	     ftnlen);

    /* Fortran I/O blocks */
    static cilist io___504 = { 0, 13, 0, fmt_1301, 0 };
    static cilist io___505 = { 0, 13, 0, fmt_1302, 0 };
    static cilist io___507 = { 0, 13, 0, fmt_1302, 0 };
    static cilist io___521 = { 0, 21, 0, 0, 0 };
    static cilist io___522 = { 0, 21, 0, fmt_500, 0 };
    static cilist io___523 = { 0, 21, 0, fmt_501, 0 };
    static cilist io___525 = { 0, 21, 0, fmt_502, 0 };
...
/*     do the ray-tracing : */
    ...
    raypath_(&c__1, &c__1, &c__1, &c_b2408, &c_b2408, &c_b2408, &c_b2408, &nl,
	    ...
	    &mll, &ster, &direr, &refrer, &refler, &dtddrefl, &dtdhrefl, bo, 
	    bo_len);
...
L5:
    travderiv_("direct", &nl, &mll, v1, vsq1, rp, &nrp, x2, y2, z2, ss, &r1, &
	    r2, i__, nobs, bo, (ftnlen)6, bo_len);
    goto L40;
L6:
    travderiv_("refracted", &nl, &mll, v1, vsq1, rp, &nrp, x2, y2, z2, ss, &
	    r1, &r2, i__, nobs, bo, (ftnlen)9, bo_len);
    goto L40;
L8:
	...
	integer *nobs, integer *i__, integer *k1, integer *mll)
{
    ...
    /* Fortran I/O blocks */
    static cilist io___530 = { 0, 78, 0, "(2x,'RFR',3f10.3,'        .1')", 0 }
	    ;
    static cilist io___531 = { 0, 78, 0, "(2x,'RFR',3f10.3,'        .1')", 0 }
	    ;
    static cilist io___532 = { 0, 78, 0, "(2x,'RFR',3f10.3,'        .1')", 0 }
	    ;
    static cilist io___533 = { 0, 77, 0, "(2x,'RFL',3f10.4,'        .1')", 0 }
	    ;
    static cilist io___541 = { 0, 79, 0, "(1x,f6.2,2x,f7.3)", 0 };
...
/* of subr. resisave */
/* Subroutine */ int adjustmodel_(real *damp, char *bo, ftnlen bo_len)
{
    /* Format strings */
    ...
    double sqrt(doublereal);
    integer s_wsli(icilist *), e_wsli(void), s_wsfi(icilist *), e_wsfi(void), 
	    do_fio(integer *, char *, ftnlen), s_wsfe(cilist *), e_wsfe(void),
    ...
    /* Fortran I/O blocks */
    static cilist io___557 = { 0, 6, 0, "(1x,'WARNING: Tried to introduce a "
	    "',                             'low-velocity-layer! (Layer ',i2,"
	    "')')", 0 };
    static cilist io___558 = { 0, 6, 0, "(1x,'Setting DVP from ',f5.2,' to 0"
...
/*            write(bo,*)' *** depth-adjustment constrained for event ',i */
		adlineb_(bo, bo_len);
		if (a4_1.b[3] > 0.f) {
...
/*        b(jj) directly: */
	    ...
	    event_1.iconstrain[i__ - 1] = 1;
/*         write(bo,'('' ***** depth constrained for event '',i5)') i */
	    adlineb_(bo, bo_len);
	}
...
/*   <<---- VELOCITY-ADJUSTMENT */
		...
		if (kj > 1) {
			...
			if (! coordsyst_1.single_turbo__) {
			    ...
			    ici__1.icirlen = bo_len;
			    ici__1.iciunit = bo;
			    ici__1.icifmt = "(1x,'WARNING: Tried to introduc"
				    "e a ',                            'low-v"
				    "elocity-layer! (Layer ',i2,')')";
			    s_wsfi(&ici__1);
			    ...
			    ici__1.icirlen = bo_len;
			    ici__1.iciunit = bo;
			    ici__1.icifmt = "(1x,'Setting DVP from ',f5.2,' "
				    "to 0.0 and',                    ' VP to "
				    "vp(layer_above)+0.001')";
			    s_wsfi(&ici__1);
...
/* no station-correction adjustments... */
	...
	ici__1.icirlen = bo_len;
	ici__1.iciunit = bo;
	ici__1.icifmt = "(' doing station-correction adjustments...')";
	s_wsfi(&ici__1);
	e_wsfi();
	ici__1.icierr = 0;
	ici__1.icirnum = 1;
...
/* of subr. adjustmodel */
/* Subroutine */ int rmsdatvar_(char *bo, ftnlen bo_len)
{
    /* Format strings */
...
/*     NVAReff is the actual number of unknowns to solve for !!! */
	...
	if (coordsyst_1.isingle == 0) {
		...
		if ((r__1 = a4_1.avres[i__ - 1], dabs(r__1)) > 1.f) {
		    ...
		    ici__1.icirlen = bo_len;
		    ici__1.iciunit = bo;
		    ici__1.icifmt = "(' Event# ',i3,' >>> ',1x,3i2.2,1x,2i2."
			    "2,                      '  AVRES =',f6.2,' NOBS "
			    "=',i3)";
		    s_wsfi(&ici__1);
		    do_fio(&c__1, (char *)&i__, (ftnlen)sizeof(integer));
...
/* of subr. rmsdatvar */
/* Subroutine */ int avresistatist_(char *bo, ftnlen bo_len)
{
    /* System generated locals */
    icilist ici__1;
    ...
    /* Builtin functions */
    integer s_wsli(icilist *), e_wsli(void), s_wsfi(icilist *), do_fio(
	    integer *, char *, ftnlen), e_wsfi(void), do_lio(integer *, 
	    integer *, char *, ftnlen);
...
/* **************   end of VELESTCOMMON.FOR  ******************************* */
    ...
    ici__1.icirlen = bo_len;
    ici__1.iciunit = bo;
    ici__1.icifmt = "(1x,'After',i3,' iterations we got:')";
    s_wsfi(&ici__1);
    do_fio(&c__1, (char *)&form_1.nitt, (ftnlen)sizeof(integer));
    e_wsfi();
    adlineb_(bo, bo_len);
    ...
    ici__1.icirlen = bo_len;
    ici__1.iciunit = bo;
    ici__1.icifmt = "(1x,i5,' straight and direct rays =',f9.5,' [',f9.5,   "
	    "        ']')";
    s_wsfi(&ici__1);
    ...
    ici__1.icirlen = bo_len;
    ici__1.iciunit = bo;
    ici__1.icifmt = "(1x,i5,' refracted           rays =',f9.5,' [',f9.5,   "
	    "        ']')";
    s_wsfi(&ici__1);
    ...
    ici__1.icirlen = bo_len;
    ici__1.iciunit = bo;
    ici__1.icifmt = "(1x,i5,' reflected           rays =',f9.5,' [',f9.5,   "
	    "        ']')";
    s_wsfi(&ici__1);
...
/* NOT the first time in this routine; proz may be calculated */
    ...
    ici__1.icirlen = bo_len;
    ici__1.iciunit = bo;
    ici__1.icifmt = "(1x,i5,' ALL                 RAYS =',f9.5,' [',f9.5,   "
	    "        ']',5x,f7.2,' %')";
    s_wsfi(&ici__1);
...
/* Subroutine */ int gapcalc_(integer *i__, char *bo, ftnlen bo_len)
{
    /* System generated locals */
    integer i__1;
    real r__1;
    ...
    /* Builtin functions */
    integer s_wsli(icilist *), do_lio(integer *, integer *, char *, ftnlen), 
	    e_wsli(void), s_wsle(cilist *), e_wsle(void);
    /* Subroutine */ int s_stop(char *, ftnlen);
    ...
    static real xhyp, yhyp, xstn, ystn;
    extern /* Subroutine */ int sorti_(integer *, integer *), adlineb_(char *,
	     ftnlen);
...
/* of subr. gapcalc */
/* Subroutine */ int backup_(char *bo, ftnlen bo_len)
{
    /* Format strings */
    ...
    /* Builtin functions */
    integer s_wsfi(icilist *), e_wsfi(void), do_fio(integer *, char *, ftnlen)
	    , s_wsli(icilist *), do_lio(integer *, integer *, char *, ftnlen),
	     e_wsli(void), s_wsfe(cilist *), e_wsfe(void), s_wsle(cilist *), 
	    e_wsle(void);
    ...
    /* Fortran I/O blocks */
    static cilist io___601 = { 0, 6, 0, "(1x,'WARNING: Tried to introduce a "
	    "',                             'low-velocity-layer! (Layer ',i2,"
	    "')')", 0 };
    static cilist io___602 = { 0, 6, 0, "(1x,'Setting DVP from ',f5.2,' to 0"
	    ".0 and',                     ' VP to vp(layer_above)+0.001')", 0 }
	    ;
...
/* Subroutine */ int steplengthcalc_(char *bo, ftnlen bo_len)
{
    /* Format strings */
...
/* Subroutine */ int resolcovar_(real *davari, char *bo, ftnlen bo_len)
{
    /* Format strings */
    ...
    /* Builtin functions */
    integer s_wsfi(icilist *), e_wsfi(void), s_wsli(icilist *), do_lio(
	    integer *, integer *, char *, ftnlen), e_wsli(void), s_wsle(
	    cilist *), e_wsle(void), do_fio(integer *, char *, ftnlen);
    double sqrt(doublereal);
    ...
    extern /* Subroutine */ int adlineb_(char *, ftnlen), spreadb_(real *, 
	    integer *, real *), spreadd_(real *, integer *, real *);
    static real avresol;

    /* Fortran I/O blocks */
    static cilist io___625 = { 0, 80, 0, 0, 0 };
    static icilist io___632 = { 0, pcard, 0, fmt_18, 80, 1 };
    static icilist io___634 = { 0, pcard+40, 0, fmt_18, 40, 1 };
    static cilist io___639 = { 0, 6, 0, "(23x,'  OT (sec)   X (km)    Y (km)"
	    "    Z (km) ')", 0 };
    static cilist io___640 = { 0, 6, 0, "(' Sigma (CHD):         ',4f10.4)", 
	    0 };
    static cilist io___641 = { 0, 6, 0, "(' Resolution (CHD):    ',4f10.4,x,"
	    "                              'D-spread =',f6.3)", 0 };
    static cilist io___642 = { 0, 6, 0, "(' Data Variance      = ',f10.4)", 0 
	    };
    static cilist io___643 = { 0, 6, 0, "(' Singular values:     ',4f10.4,5x"
	    ",'ALE =',f7.3)", 0 };
...
/* ---- resolution and covariance calculations */
	...
	e_wsfi();
	if (coordsyst_1.isingle != 0) {
/* c       write(bo,*)'CHOLESKY-decomposition:' */
	    adlineb_(bo, bo_len);
	    ici__1.icierr = 0;
	    ici__1.icirnum = 1;
	    ici__1.icirlen = bo_len;
...
/* L15: */
	...
	if (! coordsyst_1.single_turbo__) {
	    ...
	    ici__1.icirlen = bo_len;
	    ici__1.iciunit = bo;
	    ici__1.icifmt = "(1x,'D-Spread(R) = ',f6.3,                     "
		    "                     '   B-G Spread(R) = ',f6.3,        "
		    "                          '       Size (C) = ',f6.3     "
		    "                              )";
	    s_wsfi(&ici__1);
...
/* Subroutine */ int travderiv_(char *raytype, integer *nl, integer *mll, 
	...
	inobs, char *bo, ftnlen raytype_len, ftnlen bo_len)
{
    /* Format strings */
	...
	iresflag, char *bo, ftnlen bo_len)
{
    ...
    /* Builtin functions */
    integer pow_ii(integer *, integer *), s_wsli(icilist *), do_lio(integer *,
	     integer *, char *, ftnlen), e_wsli(void), s_wsfi(icilist *), 
	    do_fio(integer *, char *, ftnlen), e_wsfi(void), s_wsfe(cilist *),
	     e_wsfe(void);
    ...
    /* Fortran I/O blocks */
    static cilist io___660 = { 0, 6, 0, "(' Iteration# ',i3,' Event#',i4,' R"
...
/* observation-weight 4 ==> don't use this arr */
	...
	ici__1.icirlen = bo_len;
	ici__1.iciunit = bo;
	ici__1.icifmt = "(' Iteration# ',i3,' Event#',i4,' Res#',i3,        "
...
/* of subr. reviveobs */
/* Subroutine */ int detnofunknowns_(char *bo, ftnlen bo_len)
{
    /* System generated locals */
    icilist ici__1;
...
/*  cuk !BELOW!! cuk */
	...
	ici__1.icirlen = bo_len;
	ici__1.iciunit = bo;
	ici__1.icifmt = "(' Number of unknowns (for array-indexing): ',     "
		"              ' nvar = ',i4)";
	s_wsfi(&ici__1);
	do_fio(&c__1, (char *)&dimen_1.nvar, (ftnlen)sizeof(integer));
	e_wsfi();
	...
	ici__1.icirlen = bo_len;
	ici__1.iciunit = bo;
	ici__1.icifmt = "(' Number of effective unknowns        : ',        "
		"              ' nvareff = ',i4)";
	s_wsfi(&ici__1);
	...
	ici__1.icirlen = bo_len;
	ici__1.iciunit = bo;
	ici__1.icifmt = "(' Number of elements on/below main diagonal ',    "
		"              'of matrix G = At*A : kvar = ',i7)";
	s_wsfi(&ici__1);
...
/* Subroutine */ int actualstations_(char *bo, ftnlen bo_len)
{
    /* System generated locals */
    integer i__1, i__2;
    icilist ici__1;
...
/* = neqs+nshot */
	...
	if (obb_1.nactualsta[i__ - 1] > 0) {
		...
		if (modela_1.nsp == 2) {
		    ...
		    ici__1.icirlen = bo_len;
		    ici__1.iciunit = bo;
		    ici__1.icifmt = "(' readings for station ',a4,' : tot=',"
			    "                      i4,'  P:',i4,'  S:',i4)";
		    s_wsfi(&ici__1);
		    do_fio(&c__1, charc_1.stn + (i__ - 1 << 2), (ftnlen)4);
		    ...
		    ici__1.icirlen = bo_len;
		    ici__1.iciunit = bo;
		    ici__1.icifmt = "(' readings for station ',a4,' :',i4)";
		    s_wsfi(&ici__1);
		    do_fio(&c__1, charc_1.stn + (i__ - 1 << 2), (ftnlen)4);
		    do_fio(&c__1, (char *)&obb_1.nactualsta[i__ - 1], (ftnlen)
			    sizeof(integer));
	...
	ici__1.icirlen = bo_len;
	ici__1.iciunit = bo;
	ici__1.icifmt = "(' Total number of stations with readings:',i4)";
	s_wsfi(&ici__1);
	...
	ici__1.icirlen = bo_len;
	ici__1.iciunit = bo;
	ici__1.icifmt = "(' Total number of readings: ',i7)";
	s_wsfi(&ici__1);
	...
	ici__1.icirlen = bo_len;
	ici__1.iciunit = bo;
	ici__1.icifmt = "(' Total number of P readings: ',i7)";
	s_wsfi(&ici__1);
	...
	ici__1.icirlen = bo_len;
	ici__1.iciunit = bo;
	ici__1.icifmt = "(' Total number of S readings: ',i7)";
	s_wsfi(&ici__1);
...
/* Subroutine */ int finalstaresi_(char *bo, ftnlen bo_len)
{
    /* Initialized data */
    ...
    /* Builtin functions */
    integer s_wsli(icilist *), e_wsli(void), do_lio(integer *, integer *, 
	    char *, ftnlen), s_wsfi(icilist *), e_wsfi(void), do_fio(integer *
	    , char *, ftnlen);
    double sqrt(doublereal);
    /* Subroutine */ int s_copy(char *, char *, ftnlen, ftnlen);
    integer s_cmp(char *, char *, ftnlen, ftnlen), f_open(olist *), s_wsfe(
	    cilist *), e_wsfe(void), s_wsle(cilist *), e_wsle(void), f_clos(
	    cllist *);
    ...
    /* Fortran I/O blocks */
    static cilist io___693 = { 0, 12, 0, fmt_1201, 0 };
    static icilist io___698 = { 0, cline, 0, form_1.fm, 80, 1 };
    static cilist io___699 = { 0, 12, 0, "(a)", 0 };
    static cilist io___702 = { 0, 12, 0, 0, 0 };
    static cilist io___703 = { 0, 12, 0, 0, 0 };
    static cilist io___704 = { 0, 12, 0, 0, 0 };
    static cilist io___705 = { 0, 12, 0, "(f5.2,5x,f7.2,2x,f7.3,4x)", 0 };
...
/*  U.K.  3.Feb.87 */
	...
	if (coordsyst_1.isingle == 0) {
	    ...
	    ici__1.icirlen = bo_len;
	    ici__1.iciunit = bo;
	    ici__1.icifmt = "(1x,'Station residuals for event=',i4,         "
...
/* Computing 2nd power */
	...
	if (bb[m - 1] < -.1f) {
	    ...
	    ici__1.icirlen = bo_len;
	    ici__1.iciunit = bo;
	    ici__1.icifmt = "(5x,'WARNING: Station = ',a4,                  "
...
/* ek         if(iwarn.eq.0)then */
	...
	ici__1.icirlen = bo_len;
	ici__1.iciunit = bo;
	ici__1.icifmt = "(1x,a4,3x,a1,i4,3f8.4,1x,2f8.4)";
	s_wsfi(&ici__1);
	do_fio(&c__1, charc_1.stn + (m - 1 << 2), (ftnlen)4);
	...
	adlineb_(bo, bo_len);
/* ek         else */
/* ek            write(bo,'(1x,a4,3x,a1,i4,2f8.4,''   ?.?.?''1x,2f8.4, */
	adlineb_(bo, bo_len);
/* ek     &              '' <--- !!'')') */
...
/* ek         write(bo,'(1x,a4,3x,a1,i4,25x,f8.4)') */
	adlineb_(bo, bo_len);
...
/* Subroutine */ int magnitude_(integer *ievent, integer *itime)
{
    ...
    /* Fortran I/O blocks */
    static icilist io___708 = { 0, staname, 0, "(a4)", 4, 1 };
...
/* of subr. storeg */
/* Subroutine */ int singularvalues_(integer *i__, char *bo, ftnlen bo_len)
{
    /* System generated locals */
    integer i__1, i__2, i__3;
    icilist ici__1;
    ...
    /* Builtin functions */
    integer s_wsli(icilist *), do_lio(integer *, integer *, char *, ftnlen), 
	    e_wsli(void), s_wsfi(icilist *), do_fio(integer *, char *, ftnlen)
	    , e_wsfi(void);
    ...
    static real xsol[4];
    extern /* Subroutine */ int adlineb_(char *, ftnlen), alesubr_(real *, 
	    integer *, real *);
...
/* cc      write(bo,*)'SVD-solution vector:' */
    adlineb_(bo, bo_len);
/* cc      write(bo,'(1x,4(2x,f16.6))') (Xsol(jj),jj=1,nvar) */
	...
	real *b, integer *ib, integer *nb, real *s, real *wk, integer *ier)
{
    ...
    /* Fortran I/O blocks */
    static cilist io___841 = { 0, 6, 0, fmt_4501, 0 };
	...
	iv, integer *nrv, real *c__, integer *ic, integer *ncc, integer *ier)
{
    ...
    /* Fortran I/O blocks */
    static cilist io___868 = { 0, 6, 0, fmt_4500, 0 };
	...
	ftnlen staname_len)
{
    ...
    /* Fortran I/O blocks */
    static cilist io___951 = { 0, 6, 0, "(1x,'ray in the air... ! rp3=',f6.3"
	...
	vtop, real *ttt, ftnlen staname_len)
{
    ...
    /* Fortran I/O blocks */
    static cilist io___981 = { 0, 6, 0, "(1x,'BENDRAY>>> ray bended below su"
	    "rface!',                         ' Station: ',a4)", 0 };
    static cilist io___982 = { 0, 6, 0, "(1x,'dt1=',f6.3,'   dt2=',f6.3)", 0 }
	    ;
	...
	char *bo, ftnlen bo_len)
{
    ...
    extern /* Subroutine */ int direct1_(integer *, real *, real *, real *, 
	    integer *, real *, real *, real *, real *, real *, real *, char *,
	     ftnlen), adlineb_(char *, ftnlen), refract_(integer *, real *, 
	    real *, real *, integer *, real *, real *, integer *, real *, 
	    real *, real *), refpath_(real *, real *, real *, real *, real *, 
	    real *, real *, integer *, real *, real *, real *, real *, 
	    integer *, integer *, real *, real *, integer *, real *), 
	    dirpath_(real *, real *, real *, real *, real *, real *, real *, 
	    integer *, real *, real *, real *, integer *, real *, real *, 
	    real *, real *, integer *, real *), reflect1_(integer *, real *, 
	    real *, real *, integer *, real *, real *, real *, integer *, 
	    real *, real *, integer *, real *, real *, char *, ftnlen);

    /* Fortran I/O blocks */
    static cilist io___992 = { 0, 6, 0, 0, 0 };
...
/* Subroutine */ int reflect1_(integer *nl, real *v, real *vsq, real *thk, 
	...
	trefl, real *ain, integer *ierr, real *dtddrefl, real *dtdhrefl, char 
	*bo, ftnlen bo_len)
{
    /* Format strings */
	...
	*bo, ftnlen bo_len)
{
    ...
    static cilist io___1104 = { 0, 6, 0, 0, 0 };
...
/* Subroutine */ int redist_(real *xkm, real *ykm, real *xlat, real *xlon)
{
    ...
    /* Fortran I/O blocks */
    static cilist io___1235 = { 0, 6, 0, fmt_1000, 0 };
	...
	*ifil)
{
    ...
    static cilist io___1243 = { 0, 0, 0, "(' Radius at equator (REARTH)= ',f"
	    "10.5,                          '  km')", 0 };
    static cilist io___1244 = { 0, 0, 0, "('   1. / (ellipticity)      = ',f"
	    "10.3)", 0 };
    static cilist io___1245 = { 0, 0, 0, 0, 0 };
    static cilist io___1246 = { 0, 0, 0, 0, 0 };
    static cilist io___1247 = { 0, 0, 0, 0, 0 };
    static cilist io___1248 = { 0, 0, 0, "(1x,f12.7,' N',5x,f12.7,' W')", 0 };
    static cilist io___1249 = { 0, 0, 0, 0, 0 };
    static cilist io___1250 = { 0, 0, 0, 0, 0 };
    static cilist io___1251 = { 0, 0, 0, "('North  rotate= ',f6.1)", 0 };
    static cilist io___1252 = { 0, 0, 0, 0, 0 };
    static cilist io___1258 = { 0, 0, 0, "(' Radius of sphere at OLAT = ',f1"
	    "0.3,' km')", 0 };
    static cilist io___1259 = { 0, 0, 0, 0, 0 };
    static cilist io___1260 = { 0, 0, 0, 0, 0 };
    static cilist io___1261 = { 0, 0, 0, 0, 0 };
    static cilist io___1262 = { 0, 0, 0, "(1x,'RLATC = ',f12.8)", 0 };
    static cilist io___1263 = { 0, 0, 0, 0, 0 };
    static cilist io___1264 = { 0, 0, 0, fmt_4, 0 };
...
/* WRITE ELLIPSOIDE CONSTANTS */
    ...
    if (*ifil > 0) {
	io___1238.ciunit = *ifil;
	s_wsle(&io___1238);
	e_wsle();
	io___1239.ciunit = *ifil;
	s_wsle(&io___1239);
	e_wsle();
	io___1240.ciunit = *ifil;
	s_wsle(&io___1240);
...
/* bc = 1 min geogr. lon */
	...
	e_wsfe();
	io___1259.ciunit = *ifil;
	s_wsle(&io___1259);
	e_wsle();
	io___1260.ciunit = *ifil;
	s_wsle(&io___1260);
	...
	regnamfile_len, ftnlen regkoordfile_len)
{
    ...
    /* Fortran I/O blocks */
    static cilist io___1298 = { 0, 0, 0, "(i5,2x,a)", 0 };
    static cilist io___1301 = { 0, 6, 0, "('sequence error at:',i5,a,i5)", 0 }
	    ;
    static cilist io___1303 = { 0, 0, 0, "(i5,2x,a)", 0 };
    static cilist io___1305 = { 0, 6, 0, "('sequence error at:',i5,a,i5)", 0 }
	    ;
    static cilist io___1306 = { 0, 0, 0, "(i5,2x,a)", 0 };
    static cilist io___1307 = { 0, 6, 0, "('sequence error at:',i5,a,i5)", 0 }
	    ;
    static cilist io___1310 = { 0, 0, 0, "(8f9.3)", 0 };

#include "headc.h"
/* velestf.f -- translated by f2c (version 20100827).
...
static real c_b1656 = 360.f;
static real c_b2208 = 1.f;
static complex c_b2767 = {1.f,0.f};
static real c_b2790 = -1.f;
...
/* Subroutine */ int velest_(char *bo, char *ic, ftnlen bo_len, ftnlen ic_len)
{
    ...
    integer s_wsfi(icilist *), do_fio(integer *, char *, ftnlen), e_wsfi(void)
	    , s_wsli(icilist *), do_lio(integer *, integer *, char *, ftnlen),
	     e_wsli(void), f_open(olist *), f_clos(cllist *), f_rew(alist *);
    ...
    extern /* Subroutine */ int region_(integer *, real *, real *, char *, 
	    ...
	    actualstations_(char *, ftnlen), singularvalues_(integer *, char *
	    , ftnlen), detnofunknowns_(char *, ftnlen);
    ...
    static icilist io___3 = { 0, form_1.headerline+80, 0, 0, 80, 1 };
    static icilist io___4 = { 0, form_1.headerline+160, 0, 0, 80, 1 };
    static cilist io___19 = { 0, 6, 0, "(1x,' finished Iteration #',i3,'  at"
	    "',                         3x,a20,5x,'CPU-sec = ',f7.1)", 0 };
    static cilist io___20 = { 0, 6, 0, "(' WARNING: error in ludecp     ier="
	    "',i5)", 0 };
    static cilist io___25 = { 0, 75, 0, "(2x,'ALE',3f10.4,'        .1')", 0 };
    static cilist io___26 = { 0, 76, 0, "(2x,'DSP',3f10.4,'        .1')", 0 };
    static cilist io___30 = { 0, 6, 0, "(1x,'>>>   End of program VELEST at "
	    "',a20,                     ' <<<',' [ CPU-sec : ',f7.1,']')", 0 };
    static cilist io___31 = { 0, 6, 0, "(1x,'GAP = ',i3,'   NITT = ',i2,    "
	    "                           '   D-Spread =',f5.2)", 0 };
	...
	ic_len)
{
    ...
    integer s_rsfi(icilist *), e_rsfi(void), s_rsli(icilist *), do_lio(
	    integer *, integer *, char *, ftnlen), e_rsli(void), s_cmp(char *,
	     char *, ftnlen, ftnlen), s_wsfi(icilist *), e_wsfi(void), s_wsli(
	    icilist *), e_wsli(void), f_clos(cllist *);
    ...
    /* Fortran I/O blocks */
    static cilist io___37 = { 0, 10, 1, "(a)", 0 };
    static icilist io___40 = { 0, line, 0, "(a)", 80, 1 };
    static icilist io___42 = { 0, line+80, 0, 0, 80, 1 };
    static icilist io___45 = { 0, line+160, 0, 0, 80, 1 };
    static icilist io___47 = { 0, line+240, 0, 0, 80, 1 };
    static icilist io___48 = { 0, line+320, 0, 0, 80, 1 };
    static icilist io___49 = { 0, line+400, 0, 0, 80, 1 };
    static icilist io___50 = { 0, line+480, 0, 0, 80, 1 };
    static icilist io___51 = { 0, line+560, 0, 0, 80, 1 };
    static icilist io___52 = { 0, line+640, 0, 0, 80, 1 };
    static icilist io___53 = { 0, line+720, 0, 0, 80, 1 };
    static icilist io___54 = { 0, line+800, 0, 0, 80, 1 };
    static icilist io___55 = { 0, line+880, 0, "(a)", 80, 1 };
    static icilist io___56 = { 0, line+960, 0, "(a)", 80, 1 };
    static icilist io___57 = { 0, line+1040, 0, "(a)", 80, 1 };
    static icilist io___58 = { 0, line+1120, 0, "(a)", 80, 1 };
    static icilist io___59 = { 0, line+1200, 0, "(a)", 80, 1 };
    static icilist io___60 = { 0, line+1280, 0, "(a)", 80, 1 };
    static icilist io___61 = { 0, line+1360, 0, "(a)", 80, 1 };
    static icilist io___62 = { 0, line+1440, 0, "(a)", 80, 1 };
    static icilist io___63 = { 0, line+1520, 0, "(a)", 80, 1 };
    static icilist io___64 = { 0, line+1600, 0, "(a)", 80, 1 };
    static icilist io___65 = { 0, line+1680, 0, "(a)", 80, 1 };
    static icilist io___66 = { 0, line+1760, 0, "(a)", 80, 1 };
    static icilist io___67 = { 0, line+1840, 0, "(a)", 80, 1 };
    static icilist io___68 = { 0, line+1920, 0, "(a)", 80, 1 };
    static icilist io___69 = { 0, line+2000, 0, "(a)", 80, 1 };
    static icilist io___70 = { 0, line+2080, 0, "(a)", 80, 1 };
    static icilist io___71 = { 0, line+2160, 0, "(a)", 80, 1 };
    static icilist io___72 = { 0, line+2240, 0, "(a)", 80, 1 };
    static icilist io___73 = { 0, line+2320, 0, "(a)", 80, 1 };
    static icilist io___74 = { 0, line+2400, 0, "(a)", 80, 1 };
    static icilist io___75 = { 0, line+2480, 0, "(a)", 80, 1 };
    static icilist io___76 = { 0, form_1.headerline+160, 0, 0, 80, 1 };
    static cilist io___79 = { 0, 10, 0, "(a40)", 0 };
    static cilist io___81 = { 0, 10, 0, "(i3)", 0 };
    static cilist io___83 = { 0, 10, 0, fmt_1212, 0 };
    static cilist io___85 = { 0, 10, 0, fmt_12, 0 };
    static cilist io___88 = { 0, 10, 0, fmt_1, 0 };
    static cilist io___89 = { 0, 10, 0, form_1.fm, 0 };
...
/* Subroutine */ int inputdata_(integer *i__, char *bo, ftnlen bo_len)
{
    ...
    integer s_wsfe(cilist *), do_fio(integer *, char *, ftnlen), e_wsfe(void),
	     s_cmp(char *, char *, ftnlen, ftnlen), s_wsli(icilist *), do_lio(
	    integer *, integer *, char *, ftnlen), e_wsli(void), s_wsfi(
	    icilist *), e_wsfi(void);
    ...
    /* Fortran I/O blocks */
    static cilist io___123 = { 0, 2, 0, "('1 E V E N T   N R .   ',i6,      "
	    "                              '                 ',              "
	    "                              '           0                    0"
	    "')", 0 };
    static cilist io___131 = { 0, 2, 0, "(' DELETED: ',a4,                  "
	    "                           ' unknown phase is: ',a1)", 0 };
    static cilist io___133 = { 0, 2, 0, "(' DELETED: ',a4,                  "
	    "                              ' not on station-list')", 0 };
    static cilist io___135 = { 0, 2, 0, "(' DELETED: ',a4,                  "
...
/* Subroutine */ int statislout_(char *bo, ftnlen bo_len)
{
    ...
    integer s_wsli(icilist *), do_lio(integer *, integer *, char *, ftnlen), 
	    e_wsli(void), s_wsfe(cilist *), e_wsfe(void);
    double sqrt(doublereal);
    ...
    /* Fortran I/O blocks */
    static cilist io___190 = { 0, 2, 0, "(' ERROR: insufficient data to loca"
	    "te the quake!')", 0 };
    static cilist io___191 = { 0, 2, 0, "('0 DATE  ORIGIN   TIME   LAT      "
	    "LON     DEPTH ',              ' MAG  NO  DM GAP  RMS   ALE D-SPR"
	    "')", 0 };
    static cilist io___192 = { 0, 2, 0, "('0 DATE  ORIGIN TIME   LAT       L"
	    "ON     *DEPTH*',              ' MAG  NO  DM GAP  RMS   ALE D-SPR"
	    "')", 0 };
    static cilist io___193 = { 0, 2, 0, "('0 DATE  ORIGIN TIME  *LAT*     *L"
	    "ON*    *DEPTH*',              ' MAG  NO  DM GAP  RMS   ALE D-SPR"
	    "')", 0 };
    static cilist io___203 = { 0, 2, 0, "(1x,3i2.2,1x,i2,':',i2,':',f6.3,1x "
	    "                            f7.4,a1,f8.4,a1,1x,f7.3,2x,         "
	    "                              f3.1,2x,i2,1x,i3,1x,i3,f5.2,f6.2, "
	    "                                1x,f5.2)", 0 };
    static cilist io___204 = { 0, 2, 0, "('0  ERX  ERY  ERZ Q SQD  ADJ  IN N"
	    "R  ',                         'AVR   AAR  NM AVXM  SDXM IT')", 0 }
	    ;
    static cilist io___221 = { 0, 2, 0, "(1x,f5.1,f5.1,f5.1,1x,a1,1x,a1,'/',"
	    "a1,f6.2,1x,                   i2,i3,2f6.2,                      "
	    "                                i3,2x,f3.1,2x,f3.1,1x,i3)", 0 };
    static cilist io___222 = { 0, 2, 0, "('0 L+T NR:',i4,1x,a32,'CH-COORD.:'"
	    ",                  f9.3,' /',f9.3, ' KM')", 0 };
    static cilist io___223 = { 0, 2, 0, "('0 F-E NR:',i4,1x,a32,'CH-COORD.:'"
	    ",                  f9.3,' /',f9.3, ' KM')", 0 };
    static cilist io___224 = { 0, 2, 0, "('0 F-E NR:',i4,1x,a32)", 0 };
    static cilist io___225 = { 0, 2, 0, "('0 STN  DIST AZM AIN PRMK HRMN  P-"
	    "SEC  TPOBS  TPCAL ',          ' -TSCOR  P-RES   P-WT IMP STURES')"
	    , 0 };
    static cilist io___226 = { 0, 2, 0, "('        AMX PRX     SRMK XMAG  S-"
	    "SEC  TSOBS  TSCAL ',          ' -TSCOR  S-RES   S-WT IMP STURES')"
	    , 0 };
    static icilist io___241 = { 0, card, 0, "(2X,A4,1x,2i4,I4,1X,3A1,I1,a1,2"
	    "I2,3F7.3,F7.3,1x,                   f7.3,1x,f6.2,1x,f6.4,f7.3)", 
	    90, 1 };
    static icilist io___242 = { 0, card+15, 0, "(i4)", 4, 1 };
    static cilist io___243 = { 0, 2, 0, "(a)", 0 };
    static cilist io___244 = { 0, 2, 0, "(a)", 0 };
    static icilist io___246 = { 0, card, 0, "(2x,4x,i5,f4.1)", 15, 1 };
    static icilist io___247 = { 0, card+25, 0, "(f3.1)", 3, 1 };
    static icilist io___248 = { 0, card+2, 0, "(a4)", 4, 1 };
    static icilist io___249 = { 0, card+20, 0, "(3a1,i1,a1)", 5, 1 };
    static icilist io___250 = { 0, card+29, 0, "(3F7.3,F7.3,1x,f7.3,1x,F6.2,"
	    "1x,f6.4,                               f7.3)", 61, 1 };
    static cilist io___251 = { 0, 2, 0, "(a)", 0 };
...
/* Subroutine */ int finalhypocout_(char *bo, ftnlen bo_len)
{
    ...
    extern /* Subroutine */ int gapcalc_(integer *, char *, ftnlen);

    /* Fortran I/O blocks */
    static icilist io___302 = { 0, a4_1.smpline, 0, "(i4,4i2.2,i3.3,i5.5,a1,"
	    "i6.6,a1,                               i3.3,i2.2,'Ml',i4.4,2i3,'"
	    "000000000SEDL',                      2i3,i4.4,i2)", 80, 1 };
    static cilist io___303 = { 0, 11, 0, "(a80)", 0 };
    static cilist io___304 = { 0, 7, 0, "(3i2,1x,2i2,1x,f5.2,1x,f7.4,a1,1x,f"
	    "8.4,a1,2f7.2,                  4x,i3,5x,f5.2)", 0 };
    static cilist io___307 = { 0, 7, 0, fmt_19, 0 };
    static cilist io___308 = { 0, 7, 0, 0, 0 };
	...
	integer *ier, ftnlen stn_len, ftnlen sfreq_len)
{
    ...
    /* Fortran I/O blocks */
    static cilist io___311 = { 0, 10, 1, "(a)", 0 };
	...
	cphase_len, ftnlen eventtype_len)
{
    ...
    /* Fortran I/O blocks */
    static cilist io___331 = { 0, 0, 1, "(a)", 0 };
    static icilist io___333 = { 1, cline, 1, "(3i2,1x,2i2,1x,f5.2,1x,f7.4,a1"
	    ",1x,f8.4,a1,1x,f7.2,          2x,f5.2)", 80, 1 };
    static cilist io___338 = { 0, 0, 1, "(6(a4,a1,i1,f6.2))", 0 };
...
L2:
    io___331.ciunit = *iunit;
    i__1 = s_rsfe(&io___331);
    if (i__1 != 0) {
	goto L99;
    }
...
L10:
    j1 = j2 + 1;
    j2 = j1 + 5;
    io___338.ciunit = *iunit;
    i__1 = s_rsfe(&io___338);
    if (i__1 != 0) {
	goto L999;
    }
    i__2 = j2;
	...
	cphase_len, ftnlen eventtype_len)
{
    ...
    /* Fortran I/O blocks */
    static cilist io___341 = { 0, 0, 1, "(a)", 0 };
    static icilist io___343 = { 1, cline, 1, "(3i2,1x,2i2,1x,f5.2,1x,f7.4,a1"
	    ",1x,f8.4,a1,1x,f7.2,          2x,f5.2)", 80, 1 };
    static cilist io___349 = { 0, 0, 1, "(2x,a4,2x,a1,3x,i1,3x,f6.2)", 0 };
...
L2:
    io___341.ciunit = *iunit;
    i__1 = s_rsfe(&io___341);
    if (i__1 != 0) {
	goto L999;
    }
    i__1 = do_fio(&c__1, cline, (ftnlen)80);
	...
	rmk2_len, ftnlen cphase_len, ftnlen eventtype_len)
{
    ...
    /* Fortran I/O blocks */
    static cilist io___352 = { 0, 0, 1, "(a)", 0 };
    static icilist io___354 = { 0, cline, 0, "(17x,i1,i1,f5.2,2f8.3)", 80, 1 }
	    ;
    static icilist io___355 = { 1, cline, 0, "(a4,a1,a1,a1,i1,a1,5i2,f5.2,7x"
	    ",                                   f5.2,2x,a1,i1,4x,f3.0,f3.1)", 
	    80, 1 };
    static icilist io___363 = { 0, cline+63, 0, "(a1)", 1, 1 };
    static icilist io___364 = { 0, cline+75, 0, "(i4)", 4, 1 };
...
L1:
    io___352.ciunit = *iunit;
    i__1 = s_rsfe(&io___352);
    if (i__1 != 0) {
	goto L999;
    }
    i__1 = do_fio(&c__1, cline, (ftnlen)80);
	...
	rmk1_len, ftnlen rmk2_len, ftnlen cphase_len, ftnlen eventtype_len)
{
    ...
    /* Fortran I/O blocks */
    static cilist io___371 = { 0, 0, 1, "(a)", 0 };
    static icilist io___373 = { 0, cline, 0, "(29x,i2)", 80, 1 };
    static icilist io___374 = { 0, cline, 0, 0, 80, 1 };
    static cilist io___376 = { 0, 0, 1, "(a)", 0 };
    static icilist io___377 = { 0, cline, 0, "(2x,i2,1x,i2,1x,i2,1x,i2,1x,i2)"
	    , 80, 1 };
    static icilist io___383 = { 0, cline+54, 0, "(a1)", 1, 1 };
    static icilist io___384 = { 0, cline+70, 0, "(i8)", 8, 1 };
    static icilist io___385 = { 1, cline, 0, "(a4,4x,a8,a1,a1,f8.3,i2,f5.2,f"
	    "9.0,1x,a8,i3)", 80, 1 };
...
L1:
    io___371.ciunit = *iunit;
    i__1 = s_rsfe(&io___371);
    if (i__1 != 0) {
	goto L999;
    }
    i__1 = do_fio(&c__1, cline, (ftnlen)80);
	...
	iresflag, char *bo, ftnlen bo_len)
{
    ...
    /* Fortran I/O blocks */
    static cilist io___454 = { 0, 13, 0, fmt_1301, 0 };
    static cilist io___455 = { 0, 13, 0, fmt_1302, 0 };
    static cilist io___457 = { 0, 13, 0, fmt_1302, 0 };
    static cilist io___471 = { 0, 21, 0, 0, 0 };
    static cilist io___472 = { 0, 21, 0, fmt_500, 0 };
    static cilist io___473 = { 0, 21, 0, fmt_501, 0 };
    static cilist io___475 = { 0, 21, 0, fmt_502, 0 };
...
/*     do the ray-tracing : */
    ...
    raypath_(&c__1, &c__1, &c__1, &c_b2208, &c_b2208, &c_b2208, &c_b2208, &nl,
	...
	integer *nobs, integer *i__, integer *k1, integer *mll)
{
    ...
    /* Fortran I/O blocks */
    static cilist io___480 = { 0, 78, 0, "(2x,'RFR',3f10.3,'        .1')", 0 }
	    ;
    static cilist io___481 = { 0, 78, 0, "(2x,'RFR',3f10.3,'        .1')", 0 }
	    ;
    static cilist io___482 = { 0, 78, 0, "(2x,'RFR',3f10.3,'        .1')", 0 }
	    ;
    static cilist io___483 = { 0, 77, 0, "(2x,'RFL',3f10.4,'        .1')", 0 }
	    ;
    static cilist io___491 = { 0, 79, 0, "(1x,f6.2,2x,f7.3)", 0 };
...
/* Subroutine */ int resolcovar_(real *davari, char *bo, ftnlen bo_len)
{
    ...
    /* Fortran I/O blocks */
    static cilist io___565 = { 0, 80, 0, 0, 0 };
    static icilist io___572 = { 0, pcard, 0, fmt_18, 80, 1 };
    static icilist io___574 = { 0, pcard+40, 0, fmt_18, 40, 1 };
...
/* Subroutine */ int finalstaresi_(char *bo, ftnlen bo_len)
{
    ...
    /* Fortran I/O blocks */
    static cilist io___626 = { 0, 12, 0, fmt_1201, 0 };
    static icilist io___631 = { 0, cline, 0, form_1.fm, 80, 1 };
    static cilist io___632 = { 0, 12, 0, "(a)", 0 };
    static cilist io___635 = { 0, 12, 0, 0, 0 };
    static cilist io___636 = { 0, 12, 0, 0, 0 };
    static cilist io___637 = { 0, 12, 0, 0, 0 };
    static cilist io___638 = { 0, 12, 0, "(f5.2,5x,f7.2,2x,f7.3,4x)", 0 };
...
/* Subroutine */ int magnitude_(integer *ievent, integer *itime)
{
    ...
    /* Fortran I/O blocks */
    static icilist io___641 = { 0, staname, 0, "(a4)", 4, 1 };
...
/* **************   end of VELESTCOMMON.FOR  ******************************* */
    ...
    svdsoluk_(a, a4_1.rht, &dimen_1.nvar, &c_b2790, xsol, goodness_1.sv, &
	...
	real *b, integer *ib, integer *nb, real *s, real *wk, integer *ier)
{
    ...
    /* Fortran I/O blocks */
    static cilist io___774 = { 0, 6, 0, fmt_4501, 0 };
	...
	iv, integer *nrv, real *c__, integer *ic, integer *ncc, integer *ier)
{
    ...
    /* Fortran I/O blocks */
    static cilist io___801 = { 0, 6, 0, fmt_4500, 0 };
	...
	char *bo, ftnlen bo_len)
{
    ...
    extern /* Subroutine */ int direct1_(integer *, real *, real *, real *, 
	    integer *, real *, real *, real *, real *, real *, real *, char *,
	     ftnlen), refract_(integer *, real *, real *, real *, integer *, 
	    real *, real *, integer *, real *, real *, real *), refpath_(real 
	    *, real *, real *, real *, real *, real *, real *, integer *, 
	    real *, real *, real *, real *, integer *, integer *, real *, 
	    real *, integer *, real *), dirpath_(real *, real *, real *, real 
	    *, real *, real *, real *, integer *, real *, real *, real *, 
	    integer *, real *, real *, real *, real *, integer *, real *), 
	    reflect1_(integer *, real *, real *, real *, integer *, real *, 
...
/* Subroutine */ int redist_(real *xkm, real *ykm, real *xlat, real *xlon)
{
    ...
    /* Fortran I/O blocks */
    static cilist io___1147 = { 0, 6, 0, fmt_1000, 0 };
	...
	*ifil)
{
    ...
    /* Fortran I/O blocks */
    static cilist io___1150 = { 0, 0, 0, 0, 0 };
    static cilist io___1151 = { 0, 0, 0, 0, 0 };
    static cilist io___1152 = { 0, 0, 0, 0, 0 };
    static cilist io___1153 = { 0, 0, 0, 0, 0 };
    static cilist io___1154 = { 0, 0, 0, 0, 0 };
    static cilist io___1155 = { 0, 0, 0, "(' Radius at equator (REARTH)= ',f"
	    "10.5,                          '  km')", 0 };
    static cilist io___1156 = { 0, 0, 0, "('   1. / (ellipticity)      = ',f"
	    "10.3)", 0 };
    static cilist io___1157 = { 0, 0, 0, 0, 0 };
    static cilist io___1158 = { 0, 0, 0, 0, 0 };
    static cilist io___1159 = { 0, 0, 0, 0, 0 };
    static cilist io___1160 = { 0, 0, 0, "(1x,f12.7,' N',5x,f12.7,' W')", 0 };
    static cilist io___1161 = { 0, 0, 0, 0, 0 };
    static cilist io___1162 = { 0, 0, 0, 0, 0 };
    static cilist io___1163 = { 0, 0, 0, "('North  rotate= ',f6.1)", 0 };
    static cilist io___1164 = { 0, 0, 0, 0, 0 };
    static cilist io___1170 = { 0, 0, 0, "(' Radius of sphere at OLAT = ',f1"
	    "0.3,' km')", 0 };
    static cilist io___1171 = { 0, 0, 0, 0, 0 };
    static cilist io___1172 = { 0, 0, 0, 0, 0 };
    static cilist io___1173 = { 0, 0, 0, 0, 0 };
    static cilist io___1174 = { 0, 0, 0, "(1x,'RLATC = ',f12.8)", 0 };
    static cilist io___1175 = { 0, 0, 0, 0, 0 };
    static cilist io___1176 = { 0, 0, 0, fmt_4, 0 };
    static cilist io___1177 = { 0, 0, 0, 0, 0 };
	...
	regnamfile_len, ftnlen regkoordfile_len)
{
    ...
    /* Fortran I/O blocks */
    static cilist io___1210 = { 0, 0, 0, "(i5,2x,a)", 0 };
    static cilist io___1214 = { 0, 0, 0, "(i5,2x,a)", 0 };
    static cilist io___1216 = { 0, 0, 0, "(i5,2x,a)", 0 };
    static cilist io___1219 = { 0, 0, 0, "(8f9.3)", 0 };
